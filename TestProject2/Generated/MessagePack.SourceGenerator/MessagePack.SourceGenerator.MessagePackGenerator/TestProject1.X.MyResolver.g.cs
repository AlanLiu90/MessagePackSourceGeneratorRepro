...
[assembly: MsgPack::Internal.GeneratedAssemblyMessagePackResolverAttribute(typeof(TestProject1.X.MyResolver), 3, 0)]
	...
	private static class MyResolverGetFormatterHelper
	{
		...
		internal static object GetFormatter(global::System.Type t)
		{
			if (closedTypeLookup.TryGetValue(t, out int closedKey))
			{
				...
				{
					0 => new global::TestProject1.X.MyResolver.TestProject2.AFormatter(),
					_ => null, // unreachable
				};
			}
