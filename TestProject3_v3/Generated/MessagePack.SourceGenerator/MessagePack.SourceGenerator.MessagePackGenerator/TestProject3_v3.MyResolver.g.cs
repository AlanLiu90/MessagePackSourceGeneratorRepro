...
[assembly: MsgPack::Internal.GeneratedAssemblyMessagePackResolverAttribute(typeof(TestProject3_v3.MyResolver), 3, 0)]
	...
	private static class MyResolverGetFormatterHelper
	{
		...
		internal static object GetFormatter(global::System.Type t)
		{
			if (closedTypeLookup.TryGetValue(t, out int closedKey))
			{
				...
				{
					0 => new MsgPack::Formatters.ListFormatter<bool>(),
					1 => new global::TestProject3_v3.MyResolver.TestProject3_v3.AFormatter(),
					_ => null, // unreachable
				};
			}
