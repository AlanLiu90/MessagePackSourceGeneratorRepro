...
[assembly: MsgPack::Internal.GeneratedAssemblyMessagePackResolverAttribute(typeof(TestProject5_v3.MyResolver), 3, 0)]
		...
		internal static object GetFormatter(global::System.Type t)
		{
			if (closedTypeLookup.TryGetValue(t, out int closedKey))
			{
				return closedKey switch
				{
					...
					1 => new global::TestProject5_v3.MyResolver.TestProject5_v3.AFormatter(),
					_ => null, // unreachable
				};
			}
